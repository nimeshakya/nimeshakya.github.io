    ...
    return (
        <section id='about'>
            ...
            <p>
                ...
                asperiores nemo enim, porro aperiam quibusdam adipisci quaerat
                provident veritatis tenetur odio laudantium voluptatum ea
                obcaecati.
            </p>
            <div className='description-container'>
                ...
                <div className='description-texts'>
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Maiores, veritatis excepturi error harum optio atque?
                        Dolorem dignissimos provident ducimus excepturi eos
                        obcaecati asperiores maiores natus!
                    </p>
                </div>
            </div>
        </section>
